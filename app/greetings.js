...
module.exports = {
  ...
  help: function (req, res) {
    var message = Utils.getGreeting() + ' Follow the prompt you were given or saw to get started.';
    Utils.sendMessage(res, message);
  },
  ...
  ahoy: function(req, res) {
    var message = 'If you are at, or on your way to The Dollhouse, follow the prompts there. Otherwise, welcome!';
    Utils.sendMessage(res, message);
  },
